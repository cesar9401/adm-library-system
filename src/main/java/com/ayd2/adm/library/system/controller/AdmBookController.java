...
public class AdmBookController {
    ...
    @GetMapping
    public ResponseEntity<List<AdmBook>> findAll() {
    ...
    @PutMapping("/{bookId}")
    public ResponseEntity<AdmBook> create(@PathVariable("bookId") Long bookId, @RequestBody AdmBook entity) throws LibException {
